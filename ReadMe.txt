portscanner is a basic tool to scan for open ports in IP Addresses. 
...
After you enter the number of ports you want to scan, it will start scanning from port no 1 to the number of port you entered.
Afer scanning, it will show the results of only those ports, which are open. 
